...
def gen_features(state,id_team,id_player):
    ...
    return [etat.distance_ball,etat.distance_my_but,etat.distance_but_adv,etat.equ_proche_distance, etat.adv_proche_distance, etat .ball_in_my_zone,etat.adv_in_my_zone]
#Nom des features (optionel)
gen_features.names = ["ball_dist","mygoal_dist","hisgoal_dist","distance_equipier","distance_adv","balle_my_zone","balle_adv_zone"]
